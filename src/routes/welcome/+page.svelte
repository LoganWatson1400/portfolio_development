<div class="flex" style="flex-wrap: wrap; justify-content: center; padding: 0px 5%;">
  <div class="flex col" style="flex: 1 1 300px; max-width: 600px;">
    <div class="card secondary">
      ...
      <ul style="font-size: clamp(1rem, 2vw, 1.4rem); margin-top: 8px; padding-left: 20px;">
        <li>
          Type <strong class="highlight">ls</strong> 
          to list pages
        </li>
        <li>
          Type 
          <strong class="highlight">cat &lt;file&gt;</strong> 
          to read a file
        </li>
        <li>
          Type <strong class="highlight">cd &lt;dir&gt;</strong> 
          to navigate directories
        </li>
      </ul>
      <p style="font-size: clamp(1rem, 2vw, 1.4rem); margin-top: 8px;">
        You can also click the commands on the panel to the right.
      </p>
    </div>
